        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] transition-all">
            <p className="text-gray-300 mb-4 leading-relaxed tracking-wide">
              In my free time, I enjoy playing games. I also love reading books
              on personal development and technology, which help me grow both
            ...
            <div className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-500/5">
              <p className="text-white font-medium italic">
                "Keep it simple: Life is a game, and I'm here to win."
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong>🎓 S1 Teknik Informatika</strong> - Universitas
                  Digitech (On-going)
                </li>
                <li>
                  <strong>🎓 S1 Teknik Informatika</strong> - Universitas IPWIJA
                  (Semester 1-2)
                </li>
                <li>
                  <strong>💻 Rekayasa Perangkat Lunak</strong> - SMK Medikacom
                  Bandung (2020-2023)
                </li>
                <li>
                  <strong>📚 Relevant Coursework:</strong> DevSecOps, Software
                  Engineering, Web Development, Cloud Computing
                </li>
              </ul>
            </div>
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold text-lg">
                    Intern at PT INTI (Persero) as Software Engineer (Agustus
                    2022 - Oktober 2022)
                  </h4>
                  <p>
                    Responsible for redesigning the company's e-portal blog to
                    enhance user experience, developing internal applications to
                    support operations, and collaborating with the team in
                    system management and development.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg">
                    Helpdesk at PT Mitra Inti Bersama (2024 - 2025)
                  </h4>
                  <p>
                    Responsible for monitoring and handling issues, restoring
                    databases, performing data center housekeeping, creating
                    backup and restore reports for DC to DRC, and managing
